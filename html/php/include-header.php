		...
		<ul>
			...
			<li class="dropdown<?//php echo $depCurrent ?>">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="/departamentos/joyeria.php">Joyer&iacute;a</a></li>
					<li><a href="/departamentos/libros-documentos.php">Libros y Documentos</a></li>
					<li><a href="/departamentos/vinos.php">Vinos</a></li>
					<li class="divider"></li>
					<li><a href="/departamentos/oportunidades.php">Oportunidades</a></li>
					<li><a href="/departamentos/empenos.php">Empe&ntilde;os</a></li>
				</ul><!-- end .dropdown-menu -->
			</li><!-- end .dropdown -->
			<li class="dropdown">
